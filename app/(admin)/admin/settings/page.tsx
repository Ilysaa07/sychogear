        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <div className="flex items-center gap-3 max-w-xs w-full">
              ...
              <input type="number" value={settings.idrToUsdRate} disabled className="input-field w-full opacity-70 bg-brand-900/50 cursor-not-allowed" />
            </div>
            <div className="flex items-center gap-2 bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-2 rounded text-xs font-medium w-fit">
