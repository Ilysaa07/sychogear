  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        if (data.success) {
          // Parse heroImages from JSON string if it exists
      ...
      <div className="card p-6 space-y-8">
        ...
        <div>
          ...
          <p className="text-xs text-brand-500">
            Recommended size: 1920×1080px. Maximum 5 images. These will rotate automatically.
          </p>
          <input
            type="file"
            ref={fileInputRef}
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-brand-500 max-w-sm">
              Toggle on to display the Tagline, Title, Subtitle, and Buttons over the Hero image. Toggle off for a clean background.
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              ...
              onChange={(e) =>
                setSettings({ ...settings, heroShowContent: e.target.checked })
              }
            />
        ...
        <div>
          ...
          <input
            ...
            placeholder="Streetwear Collection 2026"
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Premium streetwear designed for those who dare to stand out."
      ...
      <div className="card p-6 space-y-8">
          ...
          <div className="flex gap-4 items-center">
            {settings.promoImage ? (
              ...
              <div className="w-40 aspect-[4/5] rounded border border-dashed border-white/20 flex items-center justify-center bg-brand-900/50">
                <p className="text-xs text-brand-500 text-center px-4">No image selected</p>
              </div>
            )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              type="text"
              value={settings.promoLinkUrl}
              onChange={(e) => setSettings({ ...settings, promoLinkUrl: e.target.value })}
