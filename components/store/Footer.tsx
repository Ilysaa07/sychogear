    ...
    <footer className="relative z-10 bg-brand-950 border-t border-white/5 pt-20 overflow-hidden">
      ...
      <div className="container-main py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <p className="text-brand-400 text-sm leading-relaxed max-w-sm">
              Wear your identity. We craft high-quality, bold streetwear designed to dominate the concrete landscape. Unapologetic aesthetics for those who break the mold.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="flex items-center gap-3 text-brand-400 hover:text-white transition-colors group w-fit">
                  <div className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center group-hover:border-white/40 group-hover:bg-white group-hover:text-black transition-all">
                    <span className="sr-only">sychogear</span>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[10px] tracking-widest text-brand-500 uppercase">
